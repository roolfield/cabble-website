...
export default function PrivacyPolicy() {
  return (
    <div className={styles.container}>
      ...
      <p>
        Roolfield built the Cabble app as a Freemium app. This service is
        provided by Roolfield at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Cabble unless otherwise
      ...
      <p>
        ...
        but not limited to name, country, phone number, email address and
        location data. The information that we request will be retained by us
      ...
      <p>This policy is effective as of 2021-06-19</p>
      <p>
