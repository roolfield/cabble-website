...
export default function TermsAndConditions() {
  ...
  return (
    <Layout className={styles.container} title={t(i18n)`Terms and Conditions`}>
      ...
      <p>
        The Cabble app stores and processes personal data that you have provided
        ...
        features and it could mean that the Cabble app won’t work properly or at
        all.
      </p>
      ...
      <p>
        ...
        Wi-Fi, or provided by your mobile network provider, but Roolfield cannot
      ...
      <p>
        With respect to Roolfield’s responsibility for your use of the app, when
        ...
        it available to you. Roolfield accepts no liability for any loss, direct
      ...
      <p>
        ...
        to keep using the app. Roolfield does not promise that it will always
      ...
      <p>
        ...
        competition, privacy, and false advertising, and any other Laws relevant
        to Transactions.
      </p>
      ...
      <p>
        ...
        users of the app; or (c) your use of Cabble in a manner that is illegal
        or inconsistent with our documentation and instructions.
      </p>
      <p>
        As a user payout-receiving user you also agree to defend, indemnify, and
        hold harmless all Disclaiming Entities from and against any claim, suit,
        demand, loss, liability, damage, action, or proceeding arising out of or
        relating to (d) Activity on the payout account, whether initiated by you
        or not (including all Transactions, Disputes, Refunds, Reversals,
        Claims, fines associated with such Activity, or use of the Services in a
        manner prohibited under this agreement); (e) any inaccurate or
        incomplete information provided as part of the onboarding of the
        account.
      </p>
      ...
      <p>
        To the maximum extent permitted by law, except as expressly provided in
        this agreement, Roolfield provides Cabble to you on an “as is” “as
      ...
      <p>
        In no event will a Disclaiming Entity be liable for any lost profits, or
        ...
        agreement or Cabble, including the use of, inability to use, or
        unavailability of Cabble or the Services.
      </p>

      <p>
        The Disclaiming Entities have no liability or responsibility for any (a)
        personal injury or property damage, of any nature whatsoever, resulting
        from use of Cabble or the Services; (b) damage, loss, or injury
        resulting from hacking, tampering, or other unauthorized access to, or
        use of, Cabble, including any unauthorized access to or use of
        ...
        errors inaccuracies or omissions, resulting from the use of Cabble; (e)
        information that is transmitted using Cabble that is defamatory,
      ...
      <p>
        ...
        damages and in all events will not exceed in the aggregate the amount of
        fees paid by you to Roolfield during the three (3) month period
      ...
      <p>
        ...
        product liability, or otherwise), strict liability, or any other basis.
        The limitations apply even if the Disclaiming Entities have been advised
